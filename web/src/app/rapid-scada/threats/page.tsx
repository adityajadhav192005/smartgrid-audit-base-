  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Live SCADA-backed events, anomalies, and audit-triggered attack observations</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Live Event Timeline</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="lg:col-span-2 glass-card p-0 overflow-hidden">
          <div className="px-4 py-3 border-b border-slate-700/50 text-sm font-semibold text-slate-200">Live SCADA Events</div>
        ...
        <div className="lg:col-span-3 glass-card p-5 space-y-4">
          {!selectedAttack ? (
            <div className="text-sm text-slate-400">No live SCADA threat events yet.</div>
          ) : (
            <>
