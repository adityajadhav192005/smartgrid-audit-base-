  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Live SCADA scoring profile, per-type baselines, and audit trigger rules</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="glass-card p-4 space-y-3">
          <h3 className="text-sm font-semibold text-slate-800">Method Summary</h3>
        ...
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-800 mb-3">Core Rules</h3>
          <div className="space-y-3 text-xs">
            {[
              ...
              <div key={item.label} className="glass-card p-3 border-slate-200">
                <div className="text-slate-500">{item.label}</div>
                <div className="text-slate-800 mt-1">{item.value}</div>
              </div>
            ))}
          </div>
        </div>
