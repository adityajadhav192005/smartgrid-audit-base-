    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Live SCADA posture across telemetry, anomaly state, audit pressure, and event flow</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <div className="glass-card p-4 xl:col-span-2">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Live Anomaly and Risk Trend</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Event Types</h3>
        ...
        <div className="glass-card p-4 grid grid-cols-2 gap-3">
          <div className="col-span-2 text-sm font-semibold text-slate-200">Live Health Gauges</div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
        <div className="glass-card p-4 xl:col-span-3">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-slate-200">Top Live Risk Agents</h3>
        ...
        <div className="glass-card p-4 xl:col-span-2">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-slate-200">Recent Live Events</h3>
