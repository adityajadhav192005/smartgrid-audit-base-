  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="section-header">Admin &amp; Settings</h1>
          <p className="text-sm text-slate-400 mt-1">Framework configuration — persisted to runtime config/env for effective pipeline runs</p>
        </div>
        <div className="flex gap-2">
          <button onClick={() => setVals(Object.fromEntries(Object.values(PARAMS).flat().map(p => [p.key, p.value])))}
      ...
      <div className="glass-card p-4">
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          <span className="text-slate-600">•</span>
          <Link href="/runs" className="text-cyber-blue hover:underline">Runs & Metrics</Link>
          <span className="text-slate-600">•</span>
