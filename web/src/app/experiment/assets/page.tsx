  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Latest-run asset layout, type distribution, and highest-risk experiment agents</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Highest-Risk Experiment Assets</h3>
              ...
              {topAgents.map(agent => {
                ...
                return (
                  <tr key={agent.id} className="data-table-row border-b border-slate-800/40">
                    ...
                    <td className="py-2 pr-4 text-slate-400">{row?.state ?? 'Healthy'}</td>
