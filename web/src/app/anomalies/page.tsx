  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Latest-run deviation trends, risk scores, and cross-layer stability</p>
      </div>
      ...
      {Array.isArray(summary?.attackFamilyDistribution) && summary.attackFamilyDistribution.length > 0 && (
        <div className="glass-card p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-semibold text-slate-200">Attack Family Distribution</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Experiment Health Radar</h3>
          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              {topAgents.map(agent => (
                <tr
                  key={agent.id}
                  className="data-table-row border-b border-slate-800/40 cursor-pointer"
                ...
                >
                  ...
                  <td className="py-1.5 pr-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-slate-300">{agent.anomalyScore.toFixed(3)}</span>
                    </div>
                  </td>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-200 mb-3">Active Experiment Detection Configuration</h3>
