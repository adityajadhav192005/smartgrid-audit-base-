  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Feature attribution and decision rationale from the latest experiment run</p>
      </div>
        ...
        <table className="w-full text-xs">
          ...
          <tbody>
            {xai.topFeatures.map(feature => (
              <tr key={feature.feature} className="data-table-row border-b border-slate-800/40">
                ...
                <td className="py-2 pr-6 font-mono text-slate-300">{feature.value.toFixed(3)}</td>
