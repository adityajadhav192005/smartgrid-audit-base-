  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Clear split between experiment execution status and live Rapid SCADA telemetry state</p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        <div className="glass-card p-5 space-y-4">
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2">
                <Activity size={14} className={apiHealthy ? 'text-emerald-400' : 'text-red-400'} />
                <span className="font-semibold text-slate-200">Experiment Running</span>
            ...
            <span className={cn('text-xs font-semibold', apiHealthy ? 'text-emerald-400' : 'text-red-400')}>
          ...
          <div className="flex gap-2 pt-1 flex-wrap">
            ...
            <Link href="/history" className="flex items-center gap-1.5 text-xs bg-grid-900 hover:bg-slate-700/40 border border-slate-700/50 text-slate-300 px-3 py-1.5 rounded transition-colors">
              <Clock size={11} />
        ...
        <div className="glass-card p-5 space-y-4">
          ...
          <div className="flex gap-2 pt-1 flex-wrap">
            ...
            <Link href="/blockchain" className="flex items-center gap-1.5 text-xs bg-grid-900 hover:bg-slate-700/40 border border-slate-700/50 text-slate-300 px-3 py-1.5 rounded transition-colors">
              <Link2 size={11} />
