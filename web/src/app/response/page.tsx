  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Automated response pipeline, mitigation actions, and feedback loops</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass-card p-4">
          <h3 className="text-sm font-semibold text-slate-800 mb-4">Mitigation Response Matrix</h3>
          <table className="w-full text-xs">
            ...
            <tbody>
              {[
                ...
                <tr key={row.sev} className="data-table-row border-b border-slate-200/40">
                  <td className={`py-2 pr-4 font-semibold ${row.color}`}>{row.sev}</td>
                  <td className="py-2 pr-4 font-mono text-slate-500">{row.range}</td>
      ...
      <div className="glass-card p-4">
        <h3 className="text-sm font-semibold text-slate-800 mb-3">Response Event Log</h3>
