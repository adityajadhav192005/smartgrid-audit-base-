  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Generate and download experiment artifacts, SHAP explanations, audit logs, and publication assets</p>
      </div>
          ...
          <div key={r.id} className="glass-card p-5 space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded bg-slate-50 border border-slate-200 flex items-center justify-center">{r.icon}</div>
                <div>
              ...
              <div className="flex gap-2">
                {generated.includes(r.id) ? (
                  ...
                  <button onClick={() => handleGenerate(r)}
                    className="flex items-center gap-1.5 text-xs bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 px-3 py-1.5 rounded transition-colors">
