...
import {
  ...
  Microscope, FileText, GitCompareArrows, Workflow,
} from 'lucide-react'
...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: '/experiment/methodology', label: 'Algorithm Config', icon: SlidersHorizontal },
      ...
      { href: '/experiment/workflow', label: 'Detection Workflow', icon: Workflow },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/rapid-scada/methodology', label: 'Algorithm Config', icon: SlidersHorizontal },
      { href: '/rapid-scada/timeline', label: 'Incident Timeline', icon: Clock3 },
      { href: '/rapid-scada/system', label: 'System Health', icon: HeartPulse },
